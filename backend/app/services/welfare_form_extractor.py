...
def _mock_extract(text: str) -> dict[str, Any]:
    ...
    return {
        ...
        "name_zh": {"full": "示例長者乙", "family": "示例", "given": "長者乙"},
        "name_en": {"full": "Example Elder B", "full_upper": "EXAMPLE ELDER B", "family": "EXAMPLE", "given": "ELDER B"},
        "hkid": {"main": "X000000", "check": "0", "full": "X000000(0)"},
        "sex": "F",
        "marital_status": "widowed",
        "date_of_birth": {"iso": "1952-08-22", "year": "1952", "month": "08", "day": "22"},
        "phone_home": {"area_code": "852", "number": "00000000", "full": "00000000"},
        "phone_mobile": {"area_code": "852", "number": "00000000", "full": "00000000"},
        "email": "elder@example.invalid",
        "address": {"room": "0", "floor": "0", "block": "示例座", "estate": "示例邨", "street": "示例街", "district": "示例區"},
        "address_text": "示例區示例街 0 號示例邨示例座 0 樓 0 室",
        "_extraction": {
            "confidence": 0.0,
            "notes": "[mock] 未設 LLM API key；回傳不對應任何真實人物的合成樣本。",
            "missing_fields": [],
