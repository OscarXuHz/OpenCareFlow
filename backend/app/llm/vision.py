...
def _user_prompt() -> str:
    ...
    example = {
        "fields": {
            ...
            "elder_age": 80,
            "elder_gender": "男",
            "elder_phone": "0000 0000",
            "elder_address": "示例區示例街 0 號",
            "living_alone": "是",
            "visit_date": "2026-05-01",
            "volunteer_name": "示例義工甲",
            "duration_minutes": 45,
            "mood": "良好",
            "health_concerns": "高血壓",
            "follow_up_needed": "否",
...
# ── Mock 數據池 ────────────────────────────────────────────────────────────
_MOCK_POOL = [
    {"elder_name": "示例長者甲", "elder_age": 82, "elder_gender": "女", "elder_phone": "0000 0000",
     "elder_address": "示例區示例街 1 號", "living_alone": "是",
     "visit_date": "2026-05-10", "volunteer_name": "示例義工甲", "duration_minutes": 45,
     "mood": "低落", "health_concerns": "膝關節痛, 失眠", "follow_up_needed": "是",
     "follow_up_note": "建議轉介物理治療"},
    {"elder_name": "示例長者乙", "elder_age": 76, "elder_gender": "男", "elder_phone": "0000 0000",
     "elder_address": "示例區示例街 2 號", "living_alone": "否",
     "visit_date": "2026-05-10", "volunteer_name": "示例義工乙", "duration_minutes": 30,
     "mood": "良好", "health_concerns": "高血壓控制中", "follow_up_needed": "否",
     "follow_up_note": ""},
    {"elder_name": "示例長者丙", "elder_age": 79, "elder_gender": "女", "elder_phone": "0000 0000",
     "elder_address": "示例區示例街 3 號", "living_alone": "是",
     "visit_date": "2026-05-09", "volunteer_name": "示例義工丙", "duration_minutes": 60,
     "mood": "一般", "health_concerns": "糖尿病, 視力下降", "follow_up_needed": "是",
     "follow_up_note": "下週覆診陪同"},
    {"elder_name": "示例長者丁", "elder_age": 85, "elder_gender": "男", "elder_phone": "0000 0000",
     "elder_address": "示例區示例街 4 號", "living_alone": "是",
     "visit_date": "2026-05-09", "volunteer_name": "示例義工丁", "duration_minutes": 50,
     "mood": "焦慮", "health_concerns": "近期失去配偶", "follow_up_needed": "是",
     "follow_up_note": "情緒支援, 連絡社工跟進"},
    {"elder_name": "示例長者戊", "elder_age": 88, "elder_gender": "女", "elder_phone": "0000 0000",
     "elder_address": "示例區示例街 5 號", "living_alone": "否",
     "visit_date": "2026-05-08", "volunteer_name": "示例義工戊", "duration_minutes": 40,
...
def extract_volunteer_form(photo_path: Path, photo_index: int = 0) -> dict[str, Any]:
    ...
    原始 provider 回應可能包含完整個資，只在顯式啟用
    STORE_AI_RAW_RESPONSES 時暫存於 metadata。
    """
    started = time.time()
    ...
    for attempt in range(max_attempts):
        ...
        try:
            ...
            if settings.store_ai_raw_responses:
                normalised["_meta"]["raw"] = raw_text[:8000]
            _log_event(
                "extract_ok",
                photo=photo_label,
                attempt=attempt + 1,
